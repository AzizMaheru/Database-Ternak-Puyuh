...
int main() {
    ...
    cout << "----------------------------------" << endl;
    cout << "  Data Hasil Telur Ternak Puyuh   " << endl;
    cout << "         Tani Maju Jaya           " << endl;
    cout << "----------------------------------" << endl;
...
void sortData() {
    ...
    cout << "-----------------------------" << endl;
    cout << "1. Tanggal Terbaru"  << endl;
    cout << "2. Tanggal Terlama"  << endl;
    cout << "3. Telur Terbanyak\n"  << endl;
